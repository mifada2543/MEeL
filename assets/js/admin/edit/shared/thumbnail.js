 ...
 * Fungsi handleThumbChange() dan handleCoverChange()
...
(function () {
  ...
  /**
   * Handle file input change — update img preview & show badge
   * @param {HTMLInputElement} input - file input element
   * @param {string} previewId - ID from img element
   * @param {string} badgeId - ID from changed badge
   */
