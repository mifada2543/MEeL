 ...
 * overlay upload (progress manual), drag-and-drop, dan @keyframes
 * spin. Diekstrak dari inline script agar konsisten dengan pola
 * folder assets/js/video/ (shared/, watch/, index/, upload/).
 *
...
function handleSubmit() {
    ...
    // (upload biasa, bukan streaming Transcoder). Animasi via helper bersama
