 ...
 */
/* ────────────────────────────────────────────────────────────────
 * upload/upload.js — JS halaman music/upload.php: drop-zone handler
 * (audio & cover), overlay upload (progress manual), drag-and-drop,
 * dan auto-fill metadata dari file audio via auto_metadata.php.
 * Diekstrak dari inline script agar konsisten dengan pola folder
 * assets/js/music/ (shared/, watch/, index/, view_playlist/, upload/).
 *
 * Catatan: blok PHP-kondisional (meelAlertRedirect & Swal.fire)
 * tetap inline di upload.php karena bergantung pada variabel PHP.
...
// Catatan: handleSubmit() dipanggil via atribut onsubmit="handleSubmit()"
// pada <form> — tidak perlu listener duplikat di sini.
